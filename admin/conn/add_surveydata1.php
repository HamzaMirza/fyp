	<?php
		...
		foreach($_REQUEST as $key => $item)
		{
			if($key=='name')
			 ...
			 if($name=="none"&&$fatherName=="none"&&$gender=="none"&&$dob=="none" &&$cnic=="none" &&$cast=="none"&& $religion=="none"&& $education=="none"&& $age=="none"&&$no_of_children=="none"&& $AdminName=="none"&& $phonenumber=="none"&& $maritalStatus=="none"&& $place_of_issuence=="none"&& $cnic_expiry=="none"&& $skill=="none"&& $employee_status=="none"&& $willing_for_emp=="none"&& $availabilty=="none"&& $remarks=="none")
			{
				$j="";
				foreach($_REQUEST as $key => $item)
				{
			...
			$query="INSERT INTO `surveydata`(`id`, `name`, `fatherName`, `dob`, `cnic`, `gender`, `cast`, `religion`, `education`, `age`, `no_of_children`, `AdminName`, `phonenumber`, `maritalStatus`, `place_of_issuence`, `cnic_expiry`, `skill`, `employee_status`, `willing_for_emp`, `availabilty`, `remarks`) VALUES ('','$name','$fatherName','$dob','$cnic','$gender','$cast','$religion','$education','$age','$no_of_children','$AdminName','$phonenumber','$maritalStatus','$place_of_issuence','$cnic_expiry','$skill','$employee_status','$willing_for_emp','$availabilty','$remarks')";
