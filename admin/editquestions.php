               ...
               <form class="form-horizontal" method="POST"  enctype="multipart/form-data">
				...
				<div class="alert alert-success hide" role="alert"  id="successAlert">
						<a class="alert-link" id="successMsg"></a>
						 <a class="alert-link">Redirection you in <span id="counter"></span>  seconds</a>
					</div>
				  ...
				  <div class="form-group">
				   ...
				   <div class="form-group">
                    <div class="col-sm-4 col-sm-offset-5">
                      <button type="button" id="save" class="btn btn-lg btn-danger" style="width:100%;" onClick="reqEditQuestion()">Submit</button>
                    </div>
